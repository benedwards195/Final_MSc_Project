...
export default function Cut({selected, setSelected}) {
...
// Obtain accounts information, body information and additionally cut information to check that workout does not exists
useEffect(()=> {
    fetchAccounts();
    fetchBodyAccounts();
    fetchCutInformation();
...
// Obtains cut information from the database
const fetchCutInformation = async() => {
...
// Adds cut workout to the database
...
// Tests for existing cut workout
...
if (workoutExists === true) {
    return (
        <>
            <h1><em>The current Cut workout has been already started and is in progress.</em></h1>
